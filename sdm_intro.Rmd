...
Note: I have taken a lot of ideas and material from [this intro](https://cran.r-project.org/web/packages/dismo/vignettes/sdm.pdf) to ```dismo``` package by **Robert Hijmans** and **Jane Elith**.
